...
public class Herramienta extends Fragment {
    ...
    private void crearTabs() {
        tabLayout.addTab(tabLayout.newTab().setText("Soldadura y Pasta"));
        tabLayout.addTab(tabLayout.newTab().setText("Cautines"));
        tabLayout.addTab(tabLayout.newTab().setText("Multimetros y Voltmetros"));
        tabLayout.addTab(tabLayout.newTab().setText("Desoldadores"));
        tabLayout.addTab(tabLayout.newTab().setText("Cajas y Organizadores"));
        tabLayout.addTab(tabLayout.newTab().setText("Pinzas"));
        tabLayout.addTab(tabLayout.newTab().setText("Probadores"));
    }
