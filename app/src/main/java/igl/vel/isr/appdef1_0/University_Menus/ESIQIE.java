...
public class ESIQIE extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, DrawerLayout.DrawerListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        email.setText(cro);
        headerback.setImageResource(R.drawable.esiqie);
    ...
    private void cerrarsec() {
        ...
        mAuth.signOut();
        Intent intent = new Intent(ESIQIE.this, loginActivity.class);
