...
public class Optoelectronica extends Fragment {
    View vista;
    MainActivity mainActivity;
    TabLayout tabLayout;

    public Optoelectronica() {
