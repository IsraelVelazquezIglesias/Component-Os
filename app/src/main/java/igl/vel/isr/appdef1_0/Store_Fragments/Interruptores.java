...
public class Interruptores extends Fragment {
    ...
    private void crearTabs() {
        tabLayout.addTab(tabLayout.newTab().setText("Microswitch mini"));
        tabLayout.addTab(tabLayout.newTab().setText("Microswitch"));
        tabLayout.addTab(tabLayout.newTab().setText("Jalon y otros"));
        tabLayout.addTab(tabLayout.newTab().setText("Push On-Off-On"));
        tabLayout.addTab(tabLayout.newTab().setText("Push On-Off"));
        tabLayout.addTab(tabLayout.newTab().setText("Deslizable"));
        tabLayout.addTab(tabLayout.newTab().setText("Palanca"));
        tabLayout.addTab(tabLayout.newTab().setText("Balancin"));
    }

    private void toolbarset() {
        Toolbar toolbar = vista.findViewById(R.id.toolMain);
        toolbar.setBackgroundColor(Color.parseColor("#43a047"));
        toolbar.setTitle("Interruptores");
