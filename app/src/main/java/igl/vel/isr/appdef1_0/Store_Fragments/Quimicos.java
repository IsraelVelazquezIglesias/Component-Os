...
public class Quimicos extends Fragment {
    ...
    private void crearTabs() {
        tabLayout.addTab(tabLayout.newTab().setText("Cintas de aislar"));
        tabLayout.addTab(tabLayout.newTab().setText("Tubo corrugado"));
        tabLayout.addTab(tabLayout.newTab().setText("Alcohol"));
        tabLayout.addTab(tabLayout.newTab().setText("Grasas"));
        tabLayout.addTab(tabLayout.newTab().setText("Limpiador"));
        tabLayout.addTab(tabLayout.newTab().setText("Silicones"));
        tabLayout.addTab(tabLayout.newTab().setText("Aire comprimido"));
